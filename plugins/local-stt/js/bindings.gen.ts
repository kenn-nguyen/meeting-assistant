...
export type ServerInfo = { url: string | null; status: ServerStatus; model: LocalModel | null; error: string | null }
export type ServerStatus = "unreachable" | "loading" | "ready" | "failed"
